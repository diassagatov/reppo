...
const skillHashScratch = {
  ...
  40: "Изменение внешнего вида и одежды персонажей",
  41: "Добавление и изменение фонов в проекте",
  42: "Работа с графическим редактором для создания уникальных элементов для проекта",
  43: "Создание собственного блока с определенными действиями и повторное использование в проекте",
  44: "Внедрение переменных в свой код для хранения и изменения значений (например для отслеживания состояния игры)",
  45: "Взаимодействие программ с внешним миром с использованием сенсоров",
  46: "Использование условий в проекте для принятия решения в зависимости от определенных критериев",
  47: "Использование циклов для повторяющихся задач в программе",
  48: "Управление движением объектов, изменение скорости, направления",
  49: "Реагирование программы на внешние события, вызванные пользователем (клик, нажатие на клавиши и другие)",
  50: "Анимация персонажей и других объектов",
  51: "Интеграция фоновой музыки, звуковых эффектов",
  52: "Возможность взаимодействия с персонажами двумя пользователям одновременно",
  53: "Программирование диалогов персонажей",
  54: "Создание различных сцен для проекта",
  55: "Поиск путей улучшения кода и исправления ошибок",
  56: "Использование интересных и вовлекающих механик для взаимодействий пользователя с игрой",
